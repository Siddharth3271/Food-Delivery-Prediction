...
# Example usage
api_key = "3ab68953d2f44720afd7e303e2279bb9"  # Replace with your OpenCage API key
...
set_background_image('https://plus.unsplash.com/premium_photo-1682088890639-dc1f3b08a583?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')
...
if st.button("Get ETA for Delivery!"):
    ...
    st.write(f'🍽 Your food will arrive in approximately **{round(prediction[0])} minutes**.')
